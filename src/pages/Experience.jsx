      ...
      <div className="relative">
        ...
        <div className="space-y-8">
          {experiences.map((exp, index) => (
            ...
            >
              {/* Timeline dot */}
              <div className="absolute left-[-6px] md:left-[26px] top-2 w-4 h-4 bg-primary rounded-full border-4 border-darker" />
              ...
              <div className="glass-card p-6 hover:border-primary/50 transition-all">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                  ...
                  <span className="text-sm text-gray-400 mt-2 md:mt-0 md:text-right">
                    {exp.duration}
                  </span>
                </div>
